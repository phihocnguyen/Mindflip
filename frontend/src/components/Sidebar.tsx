        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto">
            <nav className="p-4 space-y-4">
              ...
              {/* Search Bar - chỉ hiển thị khi đã đăng nhập */}
              {isAuthenticated && (
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg leading-5 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm"
                  />
                </div>
              )}
            </nav>
