...
export default function WritingGameClient() {
  // --- STATE MANAGEMENT ---
  ...
  const initializeQuestions = () => {
    ...
    const newQuestions: WritingQuestion[] = shuffledVocab.map((termData, index) => ({
      id: `wq-${index}`,
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-semibold text-gray-900 dark:text-white">Luyện Viết Từ Vựng</h1>
            </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6 text-center">
          <h2 className="text-lg font-medium text-gray-900 dark:text-white">Viết từ vựng tương ứng với định nghĩa</h2>
        </div>

        {questions.length > 0 ? (
          <div className="space-y-8">
            <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Bài tập viết</h2>
