...
export default function VocabularyCollectionClient({ 
  ...
  return (
    <div 
      className={`fixed top-0 right-0 h-full bg-white dark:bg-gray-800 shadow-2xl z-40 transition-all duration-300 ease-in-out ${
        isExpanded ? 'w-80 border-l border-gray-200 dark:border-gray-700' : 'w-12'
      }`}
      style={{ 
        maxHeight: '100vh',
        overflow: 'hidden'
    ...
    >
      {isExpanded ? (
        ...
        <div className="h-full flex flex-col items-center py-4 bg-white dark:bg-gray-800">
          {/* Collapsed view */}
          <button 
          ...
          {vocabularyWords.length > 0 && (
            <div className="mt-4 bg-blue-600 text-white text-xs font-bold rounded-full w-6 h-6 flex items-center justify-center">
