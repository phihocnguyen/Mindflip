    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-body max-w-3xl mx-auto mb-12 text-lg">
              ...
              <div className="card max-w-md mx-auto transform hover:scale-105 transition-transform duration-300">
                <div className="text-center">
                  ...
                  <p className="text-body mb-4">
                    Email: <span className="font-semibold text-indigo-600">{user?.email || 'N/A'}</span>
                  </p>
        ...
        <div className="mt-24">
          <h2 className="heading-2 text-center mb-12">Tính năng nổi bật</h2>
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="card transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="heading-3 mb-2">Bảo mật cao</h3>
            ...
            <div className="card transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="heading-3 mb-2">Hiệu suất cao</h3>
                  <p className="text-body">
            ...
            <div className="card transform hover:scale-105 transition-all duration-300 hover:shadow-xl">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="heading-3 mb-2">Dễ sử dụng</h3>
                  <p className="text-body">
